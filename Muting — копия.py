...
from PyQt5.QtWidgets import QShortcut, QApplication, QSystemTrayIcon, QStyle, QAction, qApp, QMenu, QDialog, QMainWindow
from pycaw.api.endpointvolume import IAudioEndpointVolume
from pycaw.utils import AudioUtilities, ISimpleAudioVolume
...
class HotkeyDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.Inputline.setGeometry(QtCore.QRect(150, 60, 100, 20))
        # self.Inputline.
        ...
        self.Plus_label.setGeometry(QtCore.QRect(100, 64, 10, 10))

        self.buttonBox = QtWidgets.QDialogButtonBox(self)
        self.buttonBox.setGeometry(QtCore.QRect(90, 150, 156, 23))
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.resize(307, 105)
        MainWindow.setMinimumSize(307, 105)
        ...
        GlobalBlur(self.winId(), hexColor='#a9a9a9',Acrylic=True, Dark=False)
        # self.setStyleSheet("border: 1px solid; border-color:black;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Volume Hotkey"))
